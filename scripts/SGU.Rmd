...
* Evan is in the lead of overall win percentage
* Bob's perception that segments with themes are harder isn't true overall but is true for him
* Cara's and Jay's performances are better on segments with themes than without
* The panel performs better overall when Bob answers first
* There have been 6 panelist sweeps to date and 4 hosts sweeps, 1 by Evan and 3 by Steve

## 2017 Summary Statistics - Through Episode #641
