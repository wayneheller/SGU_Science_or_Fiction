...
kable(dfAnsweringOrderPerf %>% filter(Frequency >=3), format.args = list(justify='right', width=500) , rownames=FALSE, digits=1, align = c('l', 'l', 'l','l','l','c','c','c', 'r'),format='html',table.attr = "style='width:75%;'")
```
