...
* There have been 10 panelist sweeps to date (compared to 7 in all of 2017) and 3 hosts sweeps, 1 by Bob and 2 by Steve (Steve had 5 host sweeps last year).    
...
if (TRUE) {
    dfSGUSummary <- readxl::read_excel(pathtofile, sheet = 4 )
